...
import libs.nn as customized_models

from PIL import ImageFile

ImageFile.LOAD_TRUNCATED_IMAGES = True

# import logger and printer
from libs.progress.bar import Bar
from libs.utils import accuracy, mkdir_p, AverageMeter
...
parser.add_argument("--pretrained_dir", default=None, type=str, help="pretrined model directory")
# Device options
